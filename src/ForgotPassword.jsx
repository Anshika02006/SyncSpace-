...
export default function ForgotPassword() {
  ...
  async function handleSendOtp() {
    setLoading(true);
    try {
      const res = await fetch('https://syncspace-qdhg.onrender.com/api/auth/send-otp', {
        method: 'POST',
  ...
  setLoading(true);
  try {
    const res = await fetch('https://syncspace-qdhg.onrender.com/api/auth/reset-password', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
