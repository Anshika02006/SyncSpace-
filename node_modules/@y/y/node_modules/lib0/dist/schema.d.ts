...
export function extendsShape(a: Schema<any>, b: Schema<any>): boolean;
/**
 * @template T
 ...
 */
export class $Optional<S extends Schema<any>> extends Schema<Unwrap<S> | undefined> {
    /**
     * @param {S} shape
     */
    constructor(shape: S);
...
export const $$promise: Schema<Schema<Uint8Array>>;
/**
...
export class PatternMatcher<State extends unknown = undefined, Patterns extends Pattern<any, any> = never> {
     ...
     */
    if<P, R>(pattern: P, handler: (o: NoInfer<ReadSchemaUnwrapped<P>>, s: State) => R): PatternMatcher<State, Patterns | Pattern<ReadSchemaUnwrapped<P>, R>>;
    /**
     * @template R
